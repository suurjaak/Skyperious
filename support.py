...
class FeedbackDialog(wx.Dialog):
    ...
    """
    def __init__(self, parent, title, message, text="", screenshot=None):
        ...
        sizer.Add(label, border=8, flag=wx.LEFT | wx.TOP | wx.GROW)
        edit = self.edit_text = \
            wx.TextCtrl(panel, value=text, style=wx.TE_MULTILINE)
        sizer.Add(edit, proportion=2, border=8, flag=wx.ALL | wx.GROW)
