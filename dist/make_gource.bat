...
"%GOURCE_DIR%\gource" --viewport 1280x720 --output-ppm-stream "%PPM_PATH%" --time-scale 2 --seconds-per-day 10 --file-idle-time 0 --highlight-dirs --key --max-file-lag -1 --hide mouse,users,usernames --output-framerate 30 --logo res\Icon32x32_32bit.png --logo-offset 1235x30 --title "Skyperious commit history" --path "%SOURCE_DIR%"
